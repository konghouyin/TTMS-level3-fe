<template>
    <el-table :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
        ...
        <el-table-column label="图片资源" prop="video" width="200" >
        ...
        <el-table-column label="操作">
            <div slot-scope="scope" style="display: flex;align-items:center;justify-content:space-around;">
                <el-button type="danger" @click="open('操作成功',scope.row.id,scope.row.video)" >确定</el-button>
            </div>
        </el-table-column>
    </el-table>
</template>
